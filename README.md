...
If you don't know MAX_PATH, it is recommended to use dw2.py and dw3_trun.py.
...
How to use:
  ...
  3. Run "pip install pandas openpyxl requests tqdm" in Terminal. If you have network issue, use "pip install -i https://pypi.tuna.tsinghua.edu.cn/simple pandas openpyxl requests tqdm" instead. 
